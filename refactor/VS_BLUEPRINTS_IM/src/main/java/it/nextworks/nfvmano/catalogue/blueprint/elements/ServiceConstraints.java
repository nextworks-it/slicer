...
public class ServiceConstraints implements DescriptorInformationElement {
	...
	private it.nextworks.nfvmano.catalogue.blueprint.elements.ServicePriorityLevel priority;
	
	@JsonInclude(JsonInclude.Include.NON_EMPTY)
	@ElementCollection(fetch=FetchType.EAGER)
	@Fetch(FetchMode.SELECT)
	@Cascade(org.hibernate.annotations.CascadeType.ALL)
	private List<String> preferredProviders = new ArrayList<String>();
	
	@JsonInclude(JsonInclude.Include.NON_EMPTY)
	@ElementCollection(fetch=FetchType.EAGER)
	@Fetch(FetchMode.SELECT)
	@Cascade(org.hibernate.annotations.CascadeType.ALL)
	private List<String> nonPreferredProviders = new ArrayList<String>();
	
	@JsonInclude(JsonInclude.Include.NON_EMPTY)
	@ElementCollection(fetch=FetchType.EAGER)
	@Fetch(FetchMode.SELECT)
	@Cascade(org.hibernate.annotations.CascadeType.ALL)
	private List<String> prohibitedProviders = new ArrayList<String>();
	...
	public ServiceConstraints(VsDescriptor vsd,
			...
			it.nextworks.nfvmano.catalogue.blueprint.elements.ServicePriorityLevel priority,
