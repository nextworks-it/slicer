...
public class InstantiateNetworkSliceRequestVld {
  @SerializedName("name")
  ...
  public InstantiateNetworkSliceRequestVld name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public InstantiateNetworkSliceRequestVld vimNetworkName(String vimNetworkName) {
  ...
  **/
  ...
  public InstantiateNetworkSliceRequestVld vimNetworkId(OneOfInstantiateNsRequestVldVimNetworkId vimNetworkId) {
  ...
  **/
  ...
  public InstantiateNetworkSliceRequestVld nsNet(Map<String, Object> nsNet) {
    this.nsNet = nsNet;
    return this;
  }

  public InstantiateNetworkSliceRequestVld putNsNetItem(String key, Object nsNetItem) {
    if (this.nsNet == null) {
  ...
  **/
  ...
  public InstantiateNetworkSliceRequestVld wimAccountId(OneOfInstantiateNsRequestVldWimAccountId wimAccountId) {
  ...
  **/
  ...
  public InstantiateNetworkSliceRequestVld ipProfile(Map<String, Object> ipProfile) {
    this.ipProfile = ipProfile;
    return this;
  }

  public InstantiateNetworkSliceRequestVld putIpProfileItem(String key, Object ipProfileItem) {
  ...
  **/
  ...
  public InstantiateNetworkSliceRequestVld providerNetwork(InstantiateNsRequestProvidernetwork1 providerNetwork) {
  ...
  **/
  ...
  public InstantiateNetworkSliceRequestVld vnfdConnectionPointRef(List<InstantiateNsRequestVnfdconnectionpointref> vnfdConnectionPointRef) {
    this.vnfdConnectionPointRef = vnfdConnectionPointRef;
    return this;
  }

  public InstantiateNetworkSliceRequestVld addVnfdConnectionPointRefItem(InstantiateNsRequestVnfdconnectionpointref vnfdConnectionPointRefItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    InstantiateNetworkSliceRequestVld instantiateNsRequestVld = (InstantiateNetworkSliceRequestVld) o;
