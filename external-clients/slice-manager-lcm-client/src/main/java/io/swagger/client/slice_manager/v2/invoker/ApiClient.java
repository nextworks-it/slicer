package io.swagger.client.slice_manager.v2.invoker;
...
import io.swagger.client.slice_manager.v2.invoker.auth.Authentication;
import io.swagger.client.slice_manager.v2.invoker.auth.HttpBasicAuth;
import io.swagger.client.slice_manager.v2.invoker.auth.ApiKeyAuth;
import io.swagger.client.slice_manager.v2.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.java.JavaClientCodegen", date = "2022-05-17T10:16:59.588+02:00")
@Component("io.swagger.client.slice_manager.v2.invoker.ApiClient")
public class ApiClient {
    ...
    private String basePath = "/api/v1.0";
