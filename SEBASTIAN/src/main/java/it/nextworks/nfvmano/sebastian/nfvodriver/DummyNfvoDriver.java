...
public class DummyNfvoDriver extends NfvoAbstractDriver {
	
	private Map<String, Nsd> nsds = new HashMap<>();

	public DummyNfvoDriver(String nfvoAddress, NfvoNotificationInterface nfvoNotificationManager) {
		super(NfvoDriverType.DUMMY, nfvoAddress, nfvoNotificationManager);
	}
