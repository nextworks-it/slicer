...
public class VsBlueprint implements DescriptorInformationElement {
	...
	public VsBlueprint(String vsBlueprinId,
			...
			String description,
			String imgUrl,
			List<it.nextworks.nfvmano.catalogue.blueprint.elements.VsBlueprintParameter> parameters,
	 ...
	 */
	public List<it.nextworks.nfvmano.catalogue.blueprint.elements.VsBlueprintParameter> getParameters() {
		return parameters;
	}
	 ...
	 */
	public List<it.nextworks.nfvmano.catalogue.blueprint.elements.VsComponent> getAtomicComponents() {
