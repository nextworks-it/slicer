...
import it.nextworks.nfvmano.sebastian.nsmf.sbi.nsmm.rest.auth.ApiKeyAuth;
import it.nextworks.nfvmano.sebastian.nsmf.sbi.nsmm.rest.auth.Authentication;
import it.nextworks.nfvmano.sebastian.nsmf.sbi.nsmm.rest.auth.HttpBasicAuth;
import it.nextworks.nfvmano.sebastian.nsmf.sbi.nsmm.rest.auth.OAuth;
...
public class ApiClient {
    ...
    public ApiClient setWriteTimeout(int connectionTimeout) {
        httpClient.setWriteTimeout(connectionTimeout, TimeUnit.MILLISECONDS);
        return this;
    }

    public ApiClient setReadTimeout(int connectionTimeout) {
