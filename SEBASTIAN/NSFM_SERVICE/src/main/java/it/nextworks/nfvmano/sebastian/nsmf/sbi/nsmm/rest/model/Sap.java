...
public class Sap {
  ...
  @SerializedName("floating-network-name")
  private String floatingNetworkName = null;
  ...
  public Sap floatingNetworkName(String floatingNetworkName) {
    this.floatingNetworkName = floatingNetworkName;
    return this;
  }
  ...
  **/
  @ApiModelProperty(required = true, value = "Network name of the floating network, specified in the SAP information of the NSD")
  public String getFloatingNetworkName() {
    return floatingNetworkName;
  }
  public void setFloatingNetworkName(String floatingNetworkName) {
    this.floatingNetworkName = floatingNetworkName;
  }
  
  public Sap networkName(String networkName) {
  ...
  **/
  ...
  public Sap subnetCidr(String subnetCidr) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Sap sap = (Sap) o;
    return Objects.equals(this.floatingNetworkName, sap.floatingNetworkName) &&
        Objects.equals(this.networkName, sap.networkName) &&
        Objects.equals(this.subnetCidr, sap.subnetCidr);
  }

  @Override
  public int hashCode() {
    return Objects.hash(floatingNetworkName, networkName, subnetCidr);
  }
  ...
  public String toString() {
    ...
    sb.append("    floatingNetworkName: ").append(toIndentedString(floatingNetworkName)).append("\n");
