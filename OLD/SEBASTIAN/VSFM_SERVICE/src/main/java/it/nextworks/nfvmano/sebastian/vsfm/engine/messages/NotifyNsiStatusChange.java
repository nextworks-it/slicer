...
public class NotifyNsiStatusChange extends VsmfEngineMessage {
	...
	public NotifyNsiStatusChange(@JsonProperty("nsiId") String nsiId, 
			@JsonProperty("statusChange") NetworkSliceStatusChange statusChange) {
		this.type = VsmfEngineMessageType.NOTIFY_NSI_STATUS_CHANGE;
		this.nsiId = nsiId;
