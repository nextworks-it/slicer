...
public class NotifyVsiNssiCoordinationStart extends VsmfEngineMessage{
    ...
    @JsonCreator
    public NotifyVsiNssiCoordinationStart( @JsonProperty("networkSliceInstanceId")String networkSliceInstanceId,
                                           @JsonProperty("domain")String domain) {
        this.type = VsmfEngineMessageType.NOTIFY_VSI_NSSI_COORDINATION_START;
