...
public class UpdateConfigRequest extends SetConfigRequest {

    public UpdateConfigRequest(UUID nssiId, BaseConfigurationPayload configurationPayload) {
        super(nssiId, configurationPayload);
    }
}
