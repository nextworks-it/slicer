...
public class QueryConfigRequest extends NssmfGenericNssiMessage {
    ...
    public QueryConfigRequest(UUID nssiId, UUID configurationId) {
        super(nssiId);
        this.configurationId = configurationId;
    }

    public QueryConfigRequest(UUID nssiId) {
        super(nssiId);
    }
