...
public class ONAP extends MANO {
    ...
    public ONAP(String manoId, String ipAddress, String port, MANOType manoType, String manoSite) {
    ...
    public void isValid() throws MalformattedElementException {
        if (this.ipAddress == null)
            throw new MalformattedElementException("ONAP without ipAddress");
        if (this.port == null)
            throw new MalformattedElementException("ONAP without username");
    }
}
