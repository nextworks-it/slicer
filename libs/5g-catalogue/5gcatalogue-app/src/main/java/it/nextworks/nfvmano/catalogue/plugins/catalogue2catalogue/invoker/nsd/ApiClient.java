package it.nextworks.nfvmano.catalogue.plugins.catalogue2catalogue.invoker.nsd;

import it.nextworks.nfvmano.catalogue.plugins.catalogue2catalogue.Catalogue;
import it.nextworks.nfvmano.catalogue.plugins.catalogue2catalogue.invoker.nsd.auth.ApiKeyAuth;
import it.nextworks.nfvmano.catalogue.plugins.catalogue2catalogue.invoker.nsd.auth.Authentication;
import it.nextworks.nfvmano.catalogue.plugins.catalogue2catalogue.invoker.nsd.auth.HttpBasicAuth;
import it.nextworks.nfvmano.catalogue.plugins.catalogue2catalogue.invoker.nsd.auth.OAuth;
