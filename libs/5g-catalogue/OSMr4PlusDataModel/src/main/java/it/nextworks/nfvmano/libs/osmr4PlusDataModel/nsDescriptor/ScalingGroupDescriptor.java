...
public class ScalingGroupDescriptor {
    ...
    private List<VNFDMember> vnfdMemberList;
    @JsonInclude(JsonInclude.Include.NON_NULL)
    ...
    public List<VNFDMember> getVnfdMemberList() {
        return vnfdMemberList;
    }

    public void setVnfdMemberList(List<VNFDMember> vnfdMemberList) {
        this.vnfdMemberList = vnfdMemberList;
    }
