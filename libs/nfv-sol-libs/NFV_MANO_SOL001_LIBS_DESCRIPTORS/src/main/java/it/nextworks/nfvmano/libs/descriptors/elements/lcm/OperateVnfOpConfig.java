...
@Embeddable
public class OperateVnfOpConfig implements DescriptorInformationElement {

    private String minGracefulStopTimeout;
    private String maxRecommendedGracefulStopTimeout;

    public OperateVnfOpConfig() {
    }

    public OperateVnfOpConfig(String minGracefulStopTimeout, String maxRecommendedGracefulStopTimeout) {
    ...
    public void isValid() throws MalformattedElementException {
        if (minGracefulStopTimeout == null)
            throw new MalformattedElementException("Operate VNF config data without minimum graceful stop timeout");
    }
