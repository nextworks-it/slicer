...
public class VduProfile implements DescriptorInformationElement {
    ...
    public VduProfile(Integer minNumberOfInstances, Integer maxNumberOfInstances) {
    ...
    public void isValid() throws MalformattedElementException {
        if (this.maxNumberOfInstances == null)
            throw new MalformattedElementException("VduProfile without maxNumberOfInstances");
        if (this.minNumberOfInstances == null)
            throw new MalformattedElementException("VduProfile without minNumberOfInstances");
    }
