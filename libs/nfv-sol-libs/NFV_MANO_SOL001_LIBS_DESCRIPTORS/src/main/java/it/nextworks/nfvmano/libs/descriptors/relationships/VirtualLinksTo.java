...
@Embeddable
public class VirtualLinksTo implements DescriptorInformationElement {

    private String type;
    private String name;

    public VirtualLinksTo() {

    }

    public VirtualLinksTo(String type, String name) {
        this.type = type;
        this.name = name;
    }

    public VirtualLinksTo(Relationship relationshipTemplate, String relationshipName) {
