...
@Entity
public class VNFCapabilities implements DescriptorInformationElement {
    ...
    public VNFCapabilities() {

    }

    public VNFCapabilities(List<String> monitoringParameter) {
        this.monitoringParameter = monitoringParameter;
    }

    public VNFCapabilities(VNFNode vnfNode, List<String> monitoringParameter) {
