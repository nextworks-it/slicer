...
@Embeddable
public class VduAttachesTo implements DescriptorInformationElement {

    private String type;
    private String name;

    public VduAttachesTo() {

    }

    public VduAttachesTo(String type, String name) {
        this.type = type;
        this.name = name;
    }

    public VduAttachesTo(Relationship relationshipTemplate, String relationshipName) {
