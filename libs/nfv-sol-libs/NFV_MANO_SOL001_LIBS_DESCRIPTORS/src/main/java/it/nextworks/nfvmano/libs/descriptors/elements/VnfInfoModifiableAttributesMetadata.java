...
@Entity
public class VnfInfoModifiableAttributesMetadata implements DescriptorInformationElement {
    ...
    public VnfInfoModifiableAttributesMetadata() {
    }

    public VnfInfoModifiableAttributesMetadata(VnfInfoModifiableAttributes vnfInfoModifiableAttributes, Map<String, String> metadata) {
