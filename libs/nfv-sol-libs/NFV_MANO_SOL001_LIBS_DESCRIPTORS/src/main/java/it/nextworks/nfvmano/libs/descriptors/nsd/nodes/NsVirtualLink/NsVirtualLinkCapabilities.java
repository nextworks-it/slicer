...
@Entity
public class NsVirtualLinkCapabilities implements DescriptorInformationElement {
    ...
    public NsVirtualLinkCapabilities() {

    }

    public NsVirtualLinkCapabilities(List<String> virtualLinkable) {
        this.virtualLinkable = virtualLinkable;
    }

    public NsVirtualLinkCapabilities(NsVirtualLinkNode nsVirtualLinkNode, List<String> virtualLinkable) {
